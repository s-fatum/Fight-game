...
export default defineComponent({
    ...
    setup(_, { emit }) {
        const chants = [
            ...
            ["Бегал", "зайка", "по", "дороге", "да", "устали", "сильно", "ноги", "захотелось", "зайке", "спать", "ИЩИ!"],
            ["Шел", "котик", "по", "лавочке", "раздавал", "булавочки", "кому", "десять", "кому", "пять", "ВЫХОДИ!"],
            ["Мыши", "вышли", "как-то", "раз", "посмотреть", "который", "час", "дернули", "за", "гири", "страшный", "звон", "ВОН!"],
            ["Плыл", "у", "берега", "пескарик", "потерял", "воздушный", "шарик", "сосчитай", "до", "десяти", "НАШЕЛ!"],
            ["Луноход", "луноход", "по", "луне", "идет", "вперед", "долго", "там", "ему", "ходить", "ВОДИ!"],
            ["Солнце", "в", "небе", "соль", "на", "хлебе", "вишня", "в", "саду", "а", "ты", "на", "виду", "ИДУ!"],
